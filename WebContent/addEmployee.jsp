		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">	
		       		<div class="card card-block text-xs-center">
	                	...
	                	<h4 class="card-header text-xs-center">Add an Employee to the DataBase</h4>
						<form action="AddEmployee.do">
                    		<fieldset>	
                    			<!-- id will auto-increment by the EmployeeDbDAO -->
                    		...
                    		<button class="btn btn-md text-normal btn-primary-outline" type="submit" value="Add Employee">Submit</button>
						</form>
		       		</div><!-- /.card card-block text-xs-center -->
